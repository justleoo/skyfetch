...
fn main() {
    ...
    // os
    println!("{blue}   __   _      {cyan}{}{white}{}{cyan}{}",
             "os ",
             "  ~ ",
             whoami::distro(),
             blue = colors::blue,
    ...
    // uptime
    match sys.uptime() {
        Ok(uptime) => println!("{blue} _(  )_( )_    {yellow}upt {white} ~ {yellow}{:?}", uptime,
        white = colors::white,
        yellow = colors::yellow,
        blue = colors::blue),
        Err(x) => println!("{yellow}uptime error {white}~ {yellow}{}",
                           x,
                           white = colors::white,
                           yellow = colors::yellow)
    }
    ...
    // wm
    println!("{blue}(_   _    _)   {green}{}{white}{}{green}{}",
    "wm ",
    "  ~ ",
    wm,
    blue = colors::blue,
    ...
    // terminal
    println!("{blue}  (_) (__)     {magenta}{}{white}{}{magenta}{}",
    "term",
    " ~ ",
    term,
    ...
    // shell
    println!("               {yellow_bright}{}{white}{}{yellow_bright}{}",
             "sh ",
             "  ~ ",
             shell,
